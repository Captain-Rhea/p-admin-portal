...
const { getImages, downloadImage } = usePageStorage();
...
<template>
  ...
  >
    <div class="mb-4">
      <h1 class="text-2xl font-bold">Page Image Library</h1>
      <p class="text-gray-600">
        Manage all images used in page posts. You can view, search, upload, and
    ...
    <DialogsPageStorageMultipleDeleteImages
